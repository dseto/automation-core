param(
    [string]$SessionExample = "specs/api/examples/recorder.session.login.example.json",
    [string]$UiMap = "specs/api/examples/uimap.example.yaml",
    [string]$OutputDir = "artifacts/semantic-resolution-e2e"
)
