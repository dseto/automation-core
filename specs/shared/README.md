...
- `shared/domain-model.md` — conceitos, blocos e invariantes.
- `backend/architecture/system-architecture.md` — topologia e fluxos reais (derivado do código).
- `shared/architecture-principles.md` — princípios e anti-padrões.

## Navegação rápida
- Vision: `shared/vision.md`
- Domain model: `shared/domain-model.md`
- Principles: `shared/architecture-principles.md`
- Glossary: `shared/glossary.md`
- Naming: `shared/naming-conventions.md`

## Processo operacional
- `shared/spec-driven-flow.md` — fluxo oficial de melhoria
- `_templates/delta-pack/` — templates de delta pack
