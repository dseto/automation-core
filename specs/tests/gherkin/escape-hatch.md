# Escape Hatch (Test Authoring)

> Base: `_legacy/06-escape-hatch.md`

## Quando usar
- Apenas quando o elemento não puder ser representado por `data-testid` no prazo do teste.

## Como registrar
- Marcar no feature com tag `@escape_hatch`
- Incluir comentário `TODO(uimap): ...`
- Abrir item no `releases/delta/*/backlog.md`
