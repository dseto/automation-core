# Delta Pack — 2026-01-20

Este delta pack marca a migração de **spec book sequencial** para **spec-driven best-practice**.

## Principais mudanças
- Introduz estrutura por domínios (`shared/`, `api/`, `backend/`, `frontend/`, `tests/`, `ops/`).
- Preserva o legado em `_legacy/`.
- Separa regras normativas (backend/tests/ops) de narrativa.

## Backlog legado (referência)
# Backlog Futuro
