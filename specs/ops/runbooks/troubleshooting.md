...
> Base: `_legacy/10-troubleshooting.md`

## Sintomas comuns → ações
- Falha de resolução (`E_PAGE_CONTEXT_REQUIRED`, `E_ELEMENT_NOT_FOUND`)
- Flakiness (waits/Angular stability)
- ui-map desatualizado
- data-map inválido
