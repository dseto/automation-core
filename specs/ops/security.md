...
> Base: `_legacy/08-security-and-compliance.md`

## Princípios
- Segredos não devem ser commitados (usar env vars / secret stores).
- Evidências e logs podem conter dados sensíveis → mascarar/anonimizar quando necessário.
- Respeitar RBAC/ACL em pipelines e storage.
